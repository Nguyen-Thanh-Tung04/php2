...
<head>
    ...
    <link rel="stylesheet" href="{{ BASE_URL .'./app/Views/user/commom/assets/css/vendor/vendor.min.css' }}" />
    <link rel="stylesheet" href="{{ BASE_URL .'./app/Views/user/commom/assets/css/plugins/plugins.min.css' }}" />
    <link rel="stylesheet" href="{{ BASE_URL .'./app/Views/user/commom/assets/css/style.min.css' }}">
    <!-- <link rel="stylesheet" href="assets/css/css.css"> -->
    <link rel="stylesheet" href="{{ BASE_URL .'./app/Views/user/commom/assets/css/sweetalert2.min.css' }}">


    <!-- Main Style -->
    <link rel="stylesheet" href="{{ BASE_URL .'./app/Views/user/commom/assets/css/style.css' }}" />
    <link rel="stylesheet" href="{{ BASE_URL .'./app/Views/user/commom/assets/css/css.css' }}">
</head>
