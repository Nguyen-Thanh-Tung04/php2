                ...
                <form action="<?= route("admin/product/add") ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <div class="form-group row">
                                <label for="" class="col-sm-3 label-custom text-right pr-4">Giá cũ <br><span
                                        style="font-size:12px;font-weight:normal;">(VND)</span></label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3 ">
                                    <input type="button" id="btnAddNew" value="Thêm ảnh"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="p_short_description" class="form-control" cols="30" rows="10"
                                        id="p_short_description"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="btn btn-success pull-left" type="submit" name="themmoi"
                                        value="THÊM MỚI">
                                </div>
                            </div>
                        </div>
